...
export default function SingleProduct({ route }) {
  ...
  const fetchComments = async (itemId) => {
    ...
    try {
      ...
      const response = await fetch(`${baseURL}agriccomment/comments/${itemId}`);
   ...
   const fetchRelatedData = async () => {
    ...
    try {
      ...
      const response = await fetch(`${baseURL}send/${item._id}/related`);
  ...
  const handlePostComment = async () => {
    ...
    try {
      const response = await fetch(`${baseURL}agriccomment/${item._id}/comments`, {
        method: 'POST',
