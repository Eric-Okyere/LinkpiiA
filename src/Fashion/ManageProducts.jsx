...
const ManageProducts = (props) => {
  ...
  useFocusEffect(
    useCallback(() => {
      AsyncStorage.getItem("keepLoggedIn")
                  ...
                  axios.get(`${baseURL}fashionpost/user/${myProducts.user}`)
                  .then((res)=>{
  ...
  const onBlur = () => {
    ...
    const deleteProducts = (id) =>{
      ...
      axios.put(
        `{baseURL}fashionpost/${id}/deactivate`,{
    ...
    const Listheader =()=>{
      return(
        ...
        <View style={styles.headerItem} >
        <Text style={{fontWeight:"600", right:8}} >Name</Text>
        </View>
        <View style={styles.headerItem} >
        <Text style={{fontWeight:"600", right:6}} >Price</Text>
        </View>
        {/* <View style={styles.headerItem} >
        <Text style={{fontWeight:"600", right:1}} >Loca</Text>
        </View> */}
        <View style={styles.headerItem} >
        <Text style={{fontWeight:"400", right:8}} >Approved</Text>
        </View>
        <View style={styles.headerItem} >
        <EvilIcons style={{right:5, bottom:3}} name="eye" size={30} color="black" />
