        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <ScrollView contentContainerStyle={styles.scrollBody} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.card}>
              ...
              <TextInput style={styles.input} placeholder="Amenities (WiFi, Parking etc) *" value={amenities} onChangeText={setAmenities} />
            ...
            <Animated.View style={[styles.notice, { transform: [{ scale: pulseAnim }] }]}>
              ...
              <Text style={styles.noticeText}>Verification: Approval requires Ghana Card upload in profile.</Text>
            </Animated.View>
