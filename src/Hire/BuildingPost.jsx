...
function BuildingPost({ route }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const url = editItem ? `${baseURL}buildings/${editItem.id}` : `${baseURL}buildings`;
      ...
      if (response.ok) {
        Alert.alert("Success", editItem ? "Updated!" : "Post sent for approval!");
        navigation.navigate("BuildingMana");
      }
    } catch (err) {
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <ScrollView contentContainerStyle={styles.scrollBody} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.header}>
              <Text style={styles.mainTitle}>{editItem ? "Edit Building" : "Post Property"}</Text>
              <Text style={styles.subTitle}>List your apartment or building for rent/sale</Text>
            </View>
            ...
            <View style={styles.card}>
              ...
              <TextInput style={styles.input} placeholder="Building/Apartment Name *" value={name} onChangeText={setName} />
              <TextInput style={styles.input} placeholder="Amenities (e.g. WiFi, Parking, Pool) *" value={amenities} onChangeText={setAmenities} />
              ...
              <TextInput style={styles.textArea} multiline placeholder="Provide a detailed description of the property... *" value={description} onChangeText={setDescription} />
            </View>
            ...
            <View style={styles.card}>
              ...
              <ContactField label="WhatsApp Contact" icon="logo-whatsapp" value={whatsapp} onChange={setWhatsapp} country={whatsappCountry} onSelect={setWhatsappCountry} />
              ...
              <TextInput style={styles.input} placeholder="Specific Location / Landmark" value={location} onChangeText={setLocation} />
            </View>
            ...
            <Animated.View style={[styles.notice, { transform: [{ scale: pulseAnim }] }]}>
              ...
              <Text style={styles.noticeText}>Verification: Approval requires your Ghana Card to be uploaded in profile.</Text>
            </Animated.View>
...
const styles = StyleSheet.create({
  ...
  notice: { flexDirection: "row", backgroundColor: "#f5a53d", padding: 16, borderRadius: 18, marginTop: 30, alignItems: "center", marginBottom: 60 },
