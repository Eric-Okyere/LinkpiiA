...
const EquipList = (props) => {
  ...
  return (
    <View style={styles.rowWrapper}>
      ...
      <Modal animationType='fade' transparent visible={modalVisible} onRequestClose={() => setModalVisible(false)}>
        <Pressable style={styles.modalOverlay} onPress={() => setModalVisible(false)}>
          <View style={styles.modalContent}>
            <Text style={styles.modalHeader}>Asset Actions</Text>
            <View style={styles.actionGrid}>
              <TouchableOpacity 
                style={styles.actionBox} 
                onPress={() => { props.navigation.navigate("equipost", { item: props }); setModalVisible(false); }}
              >
                <View style={[styles.iconContainer, { backgroundColor: '#e3f2fd' }]}>
                  <MaterialCommunityIcons name="clipboard-edit-outline" size={28} color="#1976d2" />
                </View>
                <Text style={styles.actionLabel}>Edit Post</Text>
              </TouchableOpacity>
      ...
      {/* --- Asset Row Card --- */}
      <TouchableOpacity
        onPress={() => props.navigation.navigate('equipadminsig', { ...props })}
      ...
      >
        ...
        <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row', justifyContent: 'flex-end' }}>
          ...
          <Feather name="more-vertical" size={14} color="#ccc" style={{ marginLeft: 5 }} />
        </View>
      </TouchableOpacity>
    </View>
  );
